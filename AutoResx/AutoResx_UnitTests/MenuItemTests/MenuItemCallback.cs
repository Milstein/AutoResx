...
using cuiliangbjgmailcom.AutoResx;

namespace AutoResx_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new AutoResxPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(cuiliangbjgmailcom.AutoResx.GuidList.guidAutoResxCmdSet, (int)cuiliangbjgmailcom.AutoResx.PkgCmdIDList.cmdidAutoResx);

...
namespace AutoResx_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(cuiliangbjgmailcom.AutoResx.GuidList.guidAutoResxCmdSet, (int)cuiliangbjgmailcom.AutoResx.PkgCmdIDList.cmdidAutoResx);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "AutoResx", "cuiliangbjgmailcom.AutoResx.AutoResxPackage");
